    ...
    <footer className="border-t border-gray-200 bg-gray-50">
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://www.linkedin.com/company/tekpoint" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-600 transition-colors" aria-label="LinkedIn">
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-[#2B2A29] mt-1">All trademarks and logos are property of their respective owners.</p>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-sm min-w-0 max-w-full">
