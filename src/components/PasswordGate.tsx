...
export default function PasswordGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a1628] to-[#1a2d4a] flex items-center justify-center p-4" role="dialog" aria-label="Site access">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md text-center">
        <img src="/images/tekpoint-logo.svg" alt="Tekpoint" className="h-10 mx-auto mb-6" width={200} height={40} />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          />
          {error && <p id="password-error" role="alert" className="text-sm text-red-500">Incorrect password. Please try again.</p>}
          <button
            type="submit"
