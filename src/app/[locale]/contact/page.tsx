...
const departments = [
  { icon: <Mail className="w-5 h-5 text-orange-600" />, key: "contact_48", email: "info@tekpoint.com" },
  { icon: <Handshake className="w-5 h-5 text-orange-600" />, key: "contact_49", email: "distribution@tekpoint.com" },
  { icon: <Truck className="w-5 h-5 text-orange-600" />, key: "contact_88", email: "logistik-kontaktformular@tekpoint.com" },
  { icon: <Megaphone className="w-5 h-5 text-orange-600" />, key: "contact_50", email: "marketing@tekpoint.com" },
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#0a1628] to-[#1a2d4a] text-white py-24 md:py-32">
        <div className="container mx-auto px-4 md:px-6">
          <span className="text-sm font-medium tracking-wide uppercase text-orange-300 mb-4 block">{t("contact_23")}</span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
            {t("contact_24")} <span className="text-orange-300">{t("contact_25")}</span>
          </h1>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <span className="text-sm font-medium tracking-wide uppercase text-orange-600 mb-3 block">{t("contact_27")}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-orange-600 font-medium mb-4">{t("contact_32")}</p>
              <div className="space-y-3 text-sm text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="tel:+4313616670" className="hover:text-orange-600 transition-colors">+43 136 16670</a>
                </div>
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-gray-400 shrink-0" />
                  <a href="mailto:dach@tekpoint.com" className="hover:text-orange-600 transition-colors">dach@tekpoint.com</a>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">{t("contact_31")}</h3>
              <p className="text-sm text-orange-600 font-medium mb-4">{t("contact_37")}</p>
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-gray-400 shrink-0 mt-0.5" />
                ...
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-gray-400 shrink-0" />
                  <a href="tel:+4921136183789" className="hover:text-orange-600 transition-colors">+49 211 36183789-0</a>
                </div>
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-gray-400 shrink-0" />
                  <a href="mailto:dach@tekpoint.com" className="hover:text-orange-600 transition-colors">dach@tekpoint.com</a>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-orange-600 font-medium mb-4">{t("contact_42")}</p>
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-start gap-2">
                  <MapPin className="w-4 h-4 text-gray-400 shrink-0 mt-0.5" />
                ...
                <div className="flex items-center gap-2">
                  <Mail className="w-4 h-4 text-gray-400 shrink-0" />
                  <a href="mailto:info@tekpoint.com" className="hover:text-orange-600 transition-colors">info@tekpoint.com</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <span className="text-sm font-medium tracking-wide uppercase text-orange-600 mb-3 block">{t("contact_45")}</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {departments.map((dept) => (
              <div key={dept.email} className="bg-white rounded-xl p-6 hover:shadow-md transition-shadow">
                ...
                <a href={`mailto:${dept.email}`} className="text-sm text-orange-600 hover:underline break-all">{dept.email}</a>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <span className="text-sm font-medium tracking-wide uppercase text-orange-600 mb-3 block">{t("contact_53")}</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            <Link href="/become-a-partner" className="flex items-center gap-4 bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow group">
              ...
              <div>
                <p className="font-semibold text-gray-900 group-hover:text-orange-600 transition-colors">{t("contact_56")}</p>
            ...
            <a href="mailto:logistik-kontaktformular@tekpoint.com" className="flex items-center gap-4 bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow group">
              ...
              <div>
                <p className="font-semibold text-gray-900 group-hover:text-orange-600 transition-colors">{t("contact_58")}</p>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg text-orange-100 mb-8 max-w-2xl mx-auto">{t("contact_76")}</p>
          <a href="mailto:info@tekpoint.com" className="inline-flex items-center justify-center bg-white text-orange-600 h-12 px-8 font-medium rounded-lg hover:bg-orange-50 transition-colors">
            {t("contact_77")}
          </a>
        </div>
      </section>
